...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="index">RuchiDine.com</a>
    </div>
    <ul class="nav navbar-nav navbar-right">
      <li class="active"><a href="index">Home</a></li>
      <li  ><a href="productpage">Product</a></li>
        <li  ><a href="mailModal">Send Mail</a></li>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="d:\pic\pizza.png" alt="chania" >
      </div>

      <div class="item">
        <img src="d:\pic\french_fries.png" alt="dhania" " >
      </div>
    
      <div class="item">
        <img src="d:\pic\burger.png" alt="flower" >
      </div>
